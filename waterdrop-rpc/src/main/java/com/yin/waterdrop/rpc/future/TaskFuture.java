package com.yin.waterdrop.rpc.future;
...
public interface TaskFuture extends Future<Object>
{
    ...
    /**
     * 阻塞，返回RpcResponse中的result
     * 
     * @return
     */
    Object getResponseResult() throws InterruptedException, ExecutionException;
    
    /**
     * 定时阻塞，返回RpcResponse中的result
     * 
     * @return
     */
    Object getResponseResult(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException;

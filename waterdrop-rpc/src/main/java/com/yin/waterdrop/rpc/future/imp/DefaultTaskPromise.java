package com.yin.waterdrop.rpc.future.imp;
...
import com.yin.waterdrop.rpc.future.TaskCallback;
...
public class DefaultTaskPromise implements TaskPromise {
    ...
    @Override
    public Object getResponseResult() throws InterruptedException, ExecutionException
    {
    ...
    @Override
	public Object getResponseResult(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException 
    {
    	RpcResponse response =(RpcResponse)get(timeout, unit);
    	return response==null?null:response.getResult();
	}
